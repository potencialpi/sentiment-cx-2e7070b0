-- Atualiza limite de respostas do plano Start Quântico para 100 respostas por pesquisa
-- Data: 2025-09-03
...
BEGIN
  ...
  CASE user_plan
    WHEN 'start-quantico' THEN max_responses := 100;  -- Atualizado: 100 respostas por pesquisa
    ...
    ELSE max_responses := 50;  -- fallback conservador mantido
  END CASE;
...
COMMENT ON FUNCTION public.validate_response_limits() IS 'Valida limites de respostas por pesquisa: Start Quântico (100), Vortex Neural (250), Nexus Infinito (ilimitado)';