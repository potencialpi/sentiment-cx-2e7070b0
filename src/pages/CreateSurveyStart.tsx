...
import { Plus, Minus, ArrowLeft, LogOut, Eye, BarChart3, PieChart } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              ...
              <Badge className="bg-brand-green text-brand-white">
                ...
                {questions.map((question, index) => (
                  <div key={question.id} className="border border-border rounded-lg p-4">
                    <div className="flex items-start gap-3 mb-4">
                      <span className="bg-brand-green text-brand-white text-sm px-2 py-1 rounded font-medium">
                        {index + 1}
                      </span>
